Pod::Spec.new do |s|
  ...
  s.source                = { :http => "https://onboarding-white-label-sdks-sandbox.s3.amazonaws.com/com/onboarding/ios/IosOCR/2.0.1-rc8-alpha1/IosOCR.xcframework.zip" }
