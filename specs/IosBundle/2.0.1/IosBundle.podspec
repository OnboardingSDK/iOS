Pod::Spec.new do |s|
    ...
    s.source       = { :http => "https://white-label-sdks-production.s3.amazonaws.com/com/onboarding/ios/IosOnboardingSdk/2-0-1-IosBundle.xcframework.zip"}
    s.vendored_frameworks = 'IosBundle.xcframework'
    s.dependency 'IosDeviceScan', '= 1.0.0'
    s.dependency 'IosFaceRecon', '= 2.1.1'
    s.dependency 'IosOCR', '= 2.0.1'
