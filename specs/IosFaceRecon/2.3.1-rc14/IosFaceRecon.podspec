Pod::Spec.new do |s|
    ...
    s.source       = { :http => "https://onboarding-white-label-sdks-sandbox.s3.amazonaws.com/com/onboarding/ios/IosFaceRecon/2.3.1-rc14/IosFaceRecon.xcframework.zip" }
